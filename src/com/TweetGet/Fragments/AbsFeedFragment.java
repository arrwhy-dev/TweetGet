...
public abstract class AbsFeedFragment extends Fragment {
	...
	private String getSearchQuery(Bundle args, SharedPreferencesManager ms) {
		String query;
		if (args != null) {
